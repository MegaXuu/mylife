...
teintes douces par domaine. Maquette de référence : projet Claude Design
`7f060dea-25ad-4902-8616-2952e5f6eab6`, fichier `MyLife - Canopée.dc.html` (le dossier local
`maquettes/` a été retiré au Lot 2).
